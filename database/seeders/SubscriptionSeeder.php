...
class SubscriptionSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $subscriptions = [
            ...
            [
                'id' => 6, 'name' => 'Silver Năm', 'access_level' => 'silver', 'max_video_quality' => 720, 'duration_months' => 12,
                'description' => 'Gói Silver 12 tháng', 'price' => 790000,
                'benefits' => 'HD, 2 thiết bị và tải offline trong 12 tháng', 'created_at' => now(),
            ],
            [
                'id' => 7, 'name' => 'Gold Năm', 'access_level' => 'gold', 'max_video_quality' => 1080, 'duration_months' => 12,
            ...
            [
                'id' => 8, 'name' => 'Premium Năm', 'access_level' => 'premium', 'max_video_quality' => 2160, 'duration_months' => 12,
