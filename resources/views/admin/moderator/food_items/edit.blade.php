...
<div class="stat-card">
    <form method="POST" action="{{ route('moderator.foodItems.update', $foodItem['id']) }}" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        ...
        <div class="row">
            ...
            <div class="col-12 mb-3">
                ...
                <textarea class="form-control" id="description" name="description" rows="3">{{ $foodItem['description'] ?? '' }}</textarea>
            </div>
            <div class="col-12 mb-3">
                <div class="form-check form-switch">
                    <input class="form-check-input" type="checkbox" id="is_active" name="is_active" value="1" {{ $foodItem['is_active'] ? 'checked' : '' }}>
