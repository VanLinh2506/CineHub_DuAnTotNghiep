...
<head>
    ...
    <title><?php echo isset($title) ? $title . ' - ' : ''; ?>Nhân viên đứng quầy - CineHub</title>
...
<body>
    ...
    <div class="staff-sidebar" id="staffSidebar">
        ...
        <ul class="sidebar-menu">
            <li><a href="?route=counterStaff/sellTicket" class="<?php echo ($current_page ?? '') === 'sell_ticket' ? 'active' : ''; ?>">
                <i class="fas fa-cash-register"></i> Bán vé trực tiếp
            </a></li>
            <li><a href="?route=counterStaff/salesHistory" class="<?php echo ($current_page ?? '') === 'sales_history' ? 'active' : ''; ?>">
                <i class="fas fa-history"></i> Lịch sử bán vé
            </a></li>
            <li><a href="?route=counterStaff/scanQR" class="<?php echo ($current_page ?? '') === 'scan_qr' ? 'active' : ''; ?>">
                <i class="fas fa-qrcode"></i> Quét QR Code
            </a></li>
            <li><a href="?route=counterStaff/scannedTickets" class="<?php echo ($current_page ?? '') === 'scanned_tickets' ? 'active' : ''; ?>">
                <i class="fas fa-ticket-alt"></i> Vé đã quét
            </a></li>
            <li><a href="?route=counterStaff/showtimes" class="<?php echo ($current_page ?? '') === 'showtimes' ? 'active' : ''; ?>">
    ...
    <div class="staff-main">
        <div class="staff-header">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h4 class="mb-0"><?php echo $title ?? 'Nhân viên đứng quầy'; ?></h4>
                ...
                <div class="d-flex align-items-center gap-3">
                    <span><i class="fas fa-user-circle"></i> <?php echo htmlspecialchars($user['name'] ?? 'Nhân viên'); ?></span>
                </div>
            </div>
        </div>
