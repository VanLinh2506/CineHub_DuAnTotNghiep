...
<div class="sell-ticket-container">
    ...
    <div class="seat-selection-section">
        <h3>Chọn ghế - {{ $selected_showtime['movie_title'] }} ({{ date('H:i', strtotime($selected_showtime['show_time'])) }})</h3>
...
<script>
let selectedSeats = [];
let showtimeId = {{ $selected_showtime ? $selected_showtime['id'] : 'null' }};
let prices = {
    normal: {{ $selected_showtime ? $selected_showtime['price'] : 0 }},
    vip: {{ $selected_showtime ? ($selected_showtime['price'] * 1.5) : 0 }},
    couple: {{ $selected_showtime ? ($selected_showtime['price'] * 2.5) : 0 }}
};
