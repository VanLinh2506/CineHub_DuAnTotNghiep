            ...
            <div class="ticket-body">
                ...
                <div class="ticket-info">
                    ...
                    <div class="info-item">
                        ...
                        <div class="value">{{ $ticket['screen_name'] }}</div>
                    </div>
                    <div class="info-item">
                        <div class="label">Ngày chiếu</div>
                        <div class="value">{{ date('d/m/Y', strtotime($ticket['show_date'])) }}</div>
                    </div>
                    <div class="info-item">
                        <div class="label">Giờ chiếu</div>
                        <div class="value">{{ date('H:i', strtotime($ticket['show_time'])) }}</div>
                    </div>
                </div>
                <div class="seat-info">
                    <div class="seat-number">{{ $ticket['seat'] }}</div>
                    <div class="seat-type">
                        @php $seatTypes = ['normal' => 'Ghế thường', 'vip' => 'Ghế VIP', 'couple' => 'Ghế đôi']; @endphp
                        {{ $seatTypes[$ticket['seat_type']] ?? 'Ghế thường' }}
                    </div>
                </div>
