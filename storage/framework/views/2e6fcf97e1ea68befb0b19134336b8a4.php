...
<body>
    ...
    <div class="moderator-sidebar" id="moderatorSidebar">
        ...
        <ul class="sidebar-menu">
            <?php if(!isset($isCounterStaff) || !$isCounterStaff): ?>
            <li><a href="<?php echo e(route('moderator.index')); ?>" class="<?php echo e(($current_page ?? '') === 'dashboard' ? 'active' : ''); ?>">
                <i class="fas fa-tachometer-alt"></i> Dashboard
            </a></li>
            <li><a href="<?php echo e(route('moderator.theater')); ?>" class="<?php echo e(($current_page ?? '') === 'theater' ? 'active' : ''); ?>">
                <i class="fas fa-building"></i> Thông tin rạp
            </a></li>
            <?php endif; ?>
            <li><a href="<?php echo e(route('moderator.screens.index')); ?>" class="<?php echo e(($current_page ?? '') === 'screens' ? 'active' : ''); ?>">
                <i class="fas fa-door-open"></i> Quản lý phòng
            </a></li>
            <li><a href="<?php echo e(route('moderator.showtimes.index')); ?>" class="<?php echo e(($current_page ?? '') === 'showtimes' ? 'active' : ''); ?>">
                <i class="fas fa-calendar-alt"></i> Lịch chiếu
            </a></li>
            <li><a href="<?php echo e(route('moderator.tickets')); ?>" class="<?php echo e(($current_page ?? '') === 'tickets' ? 'active' : ''); ?>">
                <i class="fas fa-ticket-alt"></i> Quản lý vé
            </a></li>
            <li><a href="<?php echo e(route('moderator.foodItems')); ?>" class="<?php echo e(($current_page ?? '') === 'food_items' ? 'active' : ''); ?>">
                <i class="fas fa-utensils"></i> Combo & Đồ ăn
            </a></li>
            <?php if(!isset($isCounterStaff) || !$isCounterStaff): ?>
            <li><a href="<?php echo e(route('moderator.statistics')); ?>" class="<?php echo e(($current_page ?? '') === 'statistics' ? 'active' : ''); ?>">
                <i class="fas fa-chart-line"></i> Thống kê
            </a></li>
            <?php if(isset($isTheaterAdmin) && $isTheaterAdmin || isset($isModerator) && $isModerator): ?>
            <li><a href="<?php echo e(route('moderator.counterStaff')); ?>" class="<?php echo e(($current_page ?? '') === 'counter_staff' ? 'active' : ''); ?>">
                <i class="fas fa-users"></i> Quản lý nhân viên
            </a></li>
            <?php endif; ?>
            <li><a href="<?php echo e(route('moderator.permissionRequests')); ?>" class="<?php echo e(($current_page ?? '') === 'permission_requests' ? 'active' : ''); ?>">
            ...
            <li><a href="<?php echo e(route('profile.index')); ?>"><i class="fas fa-user"></i> Hồ sơ</a></li>
            <li>
        ...
        <form id="logout-form-moderator" action="<?php echo e(route('logout')); ?>" method="POST" style="display: none;">
            <?php echo csrf_field(); ?>
        </form>
    </div>
    ...
    <div class="moderator-main">
        <div class="moderator-header">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h4 class="mb-0"><?php echo e($title ?? 'Quản lý rạp'); ?></h4>
                    <?php if(isset($theater)): ?>
                        <small class="text-muted"><?php echo e($theater['name']); ?> - <?php echo e($theater['location'] ?? ''); ?></small>
                    <?php endif; ?>
                </div>
                <div class="d-flex align-items-center gap-3">
                    <span><i class="fas fa-user-circle"></i> <?php echo e($user['name'] ?? 'Moderator'); ?></span>
                </div>
            </div>
        </div>
...
<?php /**PATH D:\laragon\www\CineHub_DuAnTotNghiep\resources\views\admin\moderator\layout.blade.php ENDPATH**/ ?>