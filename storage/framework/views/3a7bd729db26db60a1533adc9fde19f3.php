...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <?php if(!isset(auth()->user()['role']) || auth()->user()['role'] !== 'moderator'): ?>
            <a href="<?php echo e(route('admin.theaters.create')); ?>" class="btn btn-primary">
            ...
            <?php $__currentLoopData = $theaters; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $theater): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="col-md-4 mb-3">
                    <div class="stat-card">
                        ...
                        <?php endif; ?>
                        <div class="mt-3">
                            <a href="<?php echo e(route('admin.theaters.show', $theater['id'])); ?>" class="btn btn-sm btn-outline-primary w-100">
                            ...
                            <?php if($canEdit || (isset($user['role']) && $user['role'] === 'admin')): ?>
                                <div class="mt-2">
                                    <a href="<?php echo e(route('admin.theaters.edit', $theater['id'])); ?>" class="btn btn-sm btn-outline-warning w-100">
...
<?php echo $__env->make('admin.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\CineHub_DuAnTotNghiep\resources\views/admin/theaters.blade.php ENDPATH**/ ?>