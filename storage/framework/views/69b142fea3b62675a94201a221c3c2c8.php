...
<div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <a href="<?php echo e(route('admin.tickets.index')); ?>" class="btn btn-secondary"><i class="fas fa-arrow-left"></i> Quay lại</a>
</div>
                ...
                <div class="list-group">
                    ...
                    <div class="list-group-item">
                        <div class="d-flex justify-content-between align-items-start mb-2">
                            <div>
                                <h6 class="mb-1">
                                    <a href="#" class="text-decoration-none"><?php echo e('#'. $st['id']); ?> - <?php echo e($st['subject']); ?></a>
                                </h6>
...
<?php echo $__env->make('admin.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\CineHub_DuAnTotNghiep\resources\views/admin/tickets/view.blade.php ENDPATH**/ ?>