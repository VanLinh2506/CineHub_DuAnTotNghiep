    ...
    <footer class="footer">
        <div class="container">
            <div class="footer-content">
                ...
                <div class="footer-section">
                    ...
                    <ul class="footer-links">
                        <li>
                            <a href="<?php echo e($baseUrl); ?>/?route=movie/index">
                                Phim mới
                            </a>
                        </li>
                ...
                <div class="footer-section">
                    ...
                    <ul class="footer-links">
                        <li>
                            <a href="<?php echo e($baseUrl); ?>/?route=movie/index&category=1">
                                Hành động
                            </a>
                        </li>

                        <li>
                            <a href="<?php echo e($baseUrl); ?>/?route=movie/index&category=2">
                                Tình cảm
                            </a>
                        </li>

                        <li>
                            <a href="<?php echo e($baseUrl); ?>/?route=movie/index&category=3">
                                Hài
                            </a>
                        </li>

                        <li>
                            <a href="<?php echo e($baseUrl); ?>/?route=movie/index&category=4">
                                Kinh dị
                            </a>
                        </li>

                        <li>
                            <a href="<?php echo e($baseUrl); ?>/?route=movie/index&category=5">
                                Hoạt hình
                            </a>
                        </li>
                    </ul>
                ...
                <div class="footer-section">
                    ...
                    <ul class="footer-links">
                        ...
                        <li>
                            <a href="<?php echo e($baseUrl); ?>/?route=booking/index">
                                Đặt vé xem phim
                            </a>
                        </li>
                    </ul>
            ...
            <div class="footer-bottom">
                <p>
                    &copy; <?php echo e(date('Y')); ?> CineHub.
...
</html><?php /**PATH D:\laragon\www\CineHub_DuAnTotNghiep\resources\views\shared\footer.blade.php ENDPATH**/ ?>