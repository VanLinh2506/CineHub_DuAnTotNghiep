...
<div class="sales-history-container">
    ...
    <div class="today-stats">
        <div class="stat-card">
            ...
            <div class="stat-info">
                <span class="stat-value"><?php echo e(number_format($todayStats['ticket_count'] ?? 0)); ?></span>
        ...
        <div class="stat-card">
            ...
            <div class="stat-info">
                <span class="stat-value"><?php echo e(number_format($todayStats['total_revenue'] ?? 0)); ?> đ</span>
    ...
    <div class="filter-section">
        <form method="GET" action="" class="filter-form">
            ...
            <div class="filter-group">
                ...
                <input type="text" name="search" value="<?php echo e($search); ?>" placeholder="Tên KH, SĐT, ghế..." class="form-control">
            </div>
    ...
    <?php else: ?>
            ...
            <table class="sales-table">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>
                            <div class="datetime">
                                <span class="date"><?php echo e(date('d/m/Y', strtotime($sale['created_at']))); ?></span>
                                <span class="time"><?php echo e(date('H:i', strtotime($sale['created_at']))); ?></span>
                            </div>
                        </td>
                        <td><strong><?php echo e($sale['movie_title']); ?></strong></td>
                        <td>
                            <div class="showtime-info">
                                <span><?php echo e(date('d/m', strtotime($sale['show_date']))); ?></span>
                                <span><?php echo e(date('H:i', strtotime($sale['show_time']))); ?></span>
                                <small><?php echo e($sale['screen_name']); ?></small>
                            </div>
                        </td>
                        <td>
                            <span class="seat-badge <?php echo e($sale['seat_type']); ?>"><?php echo e($sale['seat']); ?></span>
                        </td>
                        <td>
                            <div class="customer-info">
                                <span><?php echo e($sale['customer_name'] ?? 'Khách lẻ'); ?></span>
                                <?php if(!empty($sale['customer_phone'])): ?>
                                <small><?php echo e($sale['customer_phone']); ?></small>
                                <?php endif; ?>
                            </div>
                        </td>
                        <td><span class="price"><?php echo e(number_format($sale['price'])); ?> đ</span></td>
                        <td>
                            <a href="?route=counterStaff/printTickets&booking_id=<?php echo e($sale['booking_id']); ?>" target="_blank" class="btn btn-sm btn-print">
        ...
        <div class="pagination">
            <?php for($i = 1; $i <= $total_pages; $i++): ?>
                <a href="?route=counterStaff/salesHistory&page=<?php echo e($i); ?>&date=<?php echo e(urlencode($date)); ?>&search=<?php echo e(urlencode($search)); ?>"
                   class="page-link <?php echo e($i == $page ? 'active' : ''); ?>"><?php echo e($i); ?></a>
            <?php endfor; ?>
        </div>
        <?php endif; ?>

        <div class="total-info">Tổng: <strong><?php echo e(number_format($total)); ?></strong> vé</div>
    <?php endif; ?>
</div>
...
<?php echo $__env->make('admin.counter_staff.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\CineHub_DuAnTotNghiep\resources\views\admin\counter_staff\sales_history.blade.php ENDPATH**/ ?>