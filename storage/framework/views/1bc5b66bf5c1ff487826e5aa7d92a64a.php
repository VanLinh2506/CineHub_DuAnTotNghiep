...
<head>
    ...
    <title><?php echo e(isset($title) ? $title . ' - ' : ''); ?>Nhân viên đứng quầy - CineHub</title>
...
<body>
    ...
    <div class="staff-sidebar" id="staffSidebar">
        ...
        <ul class="sidebar-menu">
            <li><a href="<?php echo e(route('counterStaff.sellTicket')); ?>" class="<?php echo e(($current_page ?? '') === 'sell_ticket' ? 'active' : ''); ?>">
                <i class="fas fa-cash-register"></i> Bán vé trực tiếp
            </a></li>
            <li><a href="<?php echo e(route('counterStaff.salesHistory')); ?>" class="<?php echo e(($current_page ?? '') === 'sales_history' ? 'active' : ''); ?>">
                <i class="fas fa-history"></i> Lịch sử bán vé
            </a></li>
            <li><a href="<?php echo e(route('counterStaff.scanQR')); ?>" class="<?php echo e(($current_page ?? '') === 'scan_qr' ? 'active' : ''); ?>">
                <i class="fas fa-qrcode"></i> Quét QR Code
            </a></li>
            <li><a href="<?php echo e(route('counterStaff.scannedTickets')); ?>" class="<?php echo e(($current_page ?? '') === 'scanned_tickets' ? 'active' : ''); ?>">
                <i class="fas fa-ticket-alt"></i> Vé đã quét
            </a></li>
            <li><a href="<?php echo e(route('counterStaff.showtimes')); ?>" class="<?php echo e(($current_page ?? '') === 'showtimes' ? 'active' : ''); ?>">
            ...
            <li><a href="<?php echo e(route('logout')); ?>"><i class="fas fa-sign-out-alt"></i> Đăng xuất</a></li>
        </ul>
    </div>
    ...
    <div class="staff-main">
        <div class="staff-header">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h4 class="mb-0"><?php echo e($title ?? 'Nhân viên đứng quầy'); ?></h4>
                    <?php if(isset($theater)): ?>
                        <small class="text-muted"><?php echo e($theater['name']); ?> - <?php echo e($theater['location'] ?? ''); ?></small>
                    <?php endif; ?>
                </div>
                <div class="d-flex align-items-center gap-3">
                    <span><i class="fas fa-user-circle"></i> <?php echo e($user['name'] ?? 'Nhân viên'); ?></span>
                </div>
            </div>
        </div>
...
<?php /**PATH D:\laragon\www\CineHub_DuAnTotNghiep\resources\views\admin\counter_staff\layout.blade.php ENDPATH**/ ?>