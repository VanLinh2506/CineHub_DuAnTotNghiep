<?php $__env->startSection('content'); ?>
    ...
    <div class="stat-card movie-form-container">
        <form method="POST" action="<?php echo e(route('admin.movies.store')); ?>" enctype="multipart/form-data">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <select class="form-select" id="category_ids" name="category_ids[]" multiple size="4">
                        ...
                        <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($cat->id); ?>" <?php if(in_array($cat->id, old('category_ids', []))): echo 'selected'; endif; ?>>
                                <?php echo e($cat->name); ?>
                ...
                <div class="col-md-3 mb-3">
                    ...
                    <select class="form-select" id="level" name="level">
                        <option value="Free" <?php if(old('level') == 'Free'): echo 'selected'; endif; ?>>Free</option>
                        <option value="Silver" <?php if(old('level') == 'Silver'): echo 'selected'; endif; ?>>Silver</option>
                        <option value="Gold" <?php if(old('level') == 'Gold'): echo 'selected'; endif; ?>>Gold</option>
                        <option value="Premium" <?php if(old('level') == 'Premium'): echo 'selected'; endif; ?>>Premium</option>
                    </select>
                </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\CineHub_DuAnTotNghiep\resources\views/admin/movies/create.blade.php ENDPATH**/ ?>