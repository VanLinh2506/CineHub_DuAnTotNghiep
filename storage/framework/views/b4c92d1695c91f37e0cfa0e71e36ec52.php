        ...
        <div class="footer-content">
            ...
            <div class="footer-section">
                ...
                <ul class="footer-links">
                    <li><a href="<?php echo e(route('movies.index')); ?>">Phim mới</a></li>
                    <li><a href="<?php echo e(route('movies.index')); ?>">Phim hot</a></li>
                    <li><a href="<?php echo e(route('movies.phimle')); ?>">Phim lẻ</a></li>
                    <li><a href="<?php echo e(route('movies.phimbo')); ?>">Phim bộ</a></li>
                    <li><a href="<?php echo e(route('movies.index')); ?>">Phim hoạt hình</a></li>
                </ul>
            </div>
            ...
            <div class="footer-section">
                ...
                <ul class="footer-links">
                    ...
                    <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <li><a href="<?php echo e(route('movies.category', $category->id)); ?>"><?php echo e($category->name); ?></a></li>
            ...
            <div class="footer-section">
                ...
                <ul class="footer-links">
                    ...
                    <li><a href="<?php echo e(route('movies.theater')); ?>">Đặt vé xem phim</a></li>
                </ul>
            </div>
        </div>
        
        <div class="footer-bottom">
            <p>&copy; <?php echo e(date('Y')); ?> CineHub. Tất cả quyền được bảo lưu.</p>
...
<script>
    ...
    function loadNotifications() {
        ...
        fetch(`<?php echo e(route('notifications.getNotifications')); ?>?limit=10`)
            .then(response => {
                if (!response.ok) {
    ...
    function markAsRead(notificationId) {
        fetch(`<?php echo e(route('notifications.markAsRead')); ?>?id=` + notificationId, {
            method: 'GET'
