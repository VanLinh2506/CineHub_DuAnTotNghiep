...
<script>
    window.bookingPageConfig = {
        ...
        selectedTheaterId: <?php echo json_encode($selectedTheater ?? null, 15, 512) ?>,
        selectedDate: <?php echo json_encode(isset($selectedDate) && $selectedDate instanceof \Carbon\CarbonInterface ? $selectedDate->toDateString() : ($selectedDate ?? null), 15, 512) ?>,
        selectedShowtimeId: <?php echo json_encode($selectedShowtimeId ?? null, 15, 512) ?>,
        myReservedSeats: <?php echo json_encode($myReservedSeats ?? [], 15, 512) ?>,
            ...
            <div class="col-lg-5">
                ...
                <article class="booking-movie-info" itemscope itemtype="https://schema.org/Movie" style="position: sticky; top: 20px;">
                    ...
                    <div class="booking-movie-details">
                        ...
                        <?php if($bookingCategories->isNotEmpty()): ?>
                        <div class="detail-item">
                            <span class="detail-label">Thá»ƒ loáº¡i:</span>
                            <span class="detail-value"><?php echo e($bookingCategories->pluck('name')->join(', ')); ?></span>
                        </div>
                        <?php endif; ?>
                            ...
                            <div class="payment-methods" style="display: grid; grid-template-columns: 1fr 1fr; gap: 10px;">
                                ...
                                <label class="payment-method-card" style="border: 2px solid #444; border-radius: 10px; padding: 12px; cursor: pointer; transition: all 0.3s; text-align: center; display: flex; flex-direction: column; align-items: center; gap: 8px;">
                                    ...
                                    <div>
                                        ...
                                        <small style="color: #999; font-size: 11px;" id="walletBalance"><?php echo e(Auth::check() ? number_format(Auth::user()->points ?? 0) : 0); ?>Ä‘</small>
                                    </div>
                                </label>
                            </div>
                        </div>
