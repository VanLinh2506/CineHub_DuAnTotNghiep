...
@media(max-width:768px){.cinebot-toggle,.cinebot-nudge{display:none!important}.cinebot-panel{position:fixed;inset:auto 10px calc(82px + env(safe-area-inset-bottom)) auto;width:min(320px,calc(100vw - 20px));height:min(460px,calc(100vh - 110px))}}
</style>
@endonce
