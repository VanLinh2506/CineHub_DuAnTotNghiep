...
<div class="d-flex justify-content-between align-items-center mb-4">
    <h5>Cấu hình layout ghế - <?php echo e($screen['screen_name']); ?></h5>
        ...
        <div class="col-md-6">
            <div class="stat-card mb-4">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="screen_name" class="form-control" value="<?php echo e($screen['screen_name']); ?>" required>
                </div>
                <div class="mb-3">
                    <label class="form-label">Loại phòng <span class="text-danger">*</span></label>
                    <select name="screen_type" class="form-select" required>
                        <option value="2D" <?php echo e(($screen['screen_type'] ?? '2D') === '2D' ? 'selected' : ''); ?>>2D</option>
                        <option value="3D" <?php echo e(($screen['screen_type'] ?? '') === '3D' ? 'selected' : ''); ?>>3D</option>
                        <option value="IMAX" <?php echo e(($screen['screen_type'] ?? '') === 'IMAX' ? 'selected' : ''); ?>>IMAX</option>
                        <option value="4DX" <?php echo e(($screen['screen_type'] ?? '') === '4DX' ? 'selected' : ''); ?>>4DX</option>
                    </select>
                </div>
                <div class="mb-3">
                    <label class="form-label">Số ghế hiện tại:</label>
                    <input type="text" class="form-control" value="<?php echo e($screen['total_seats']); ?>" disabled>
                </div>
            </div>
        </div>
        <div class="col-md-6">
    ...
    <div class="stat-card mb-4">
        ...
        <div class="row">
            <div class="col-md-6 mb-3">
                ...
                <input type="number" name="num_groups" id="num_groups" class="form-control" min="1" value="<?php echo e($numGroups); ?>" required>
            </div>
            <div class="col-md-6 mb-3">
                <label class="form-label">Số ghế trên 1 hàng của 1 nhóm <span class="text-danger">*</span></label>
                <input type="number" name="seats_per_group_row" id="seats_per_group_row" class="form-control" min="1" value="<?php echo e($seatsPerGroupRow); ?>" required>
            </div>
        </div>
        <div class="row">
            <div class="col-md-6 mb-3">
                <label class="form-label">Số hàng ghế <span class="text-danger">*</span></label>
                <input type="number" name="num_rows" id="num_rows" class="form-control" min="1" value="<?php echo e($numRows); ?>" required>
            </div>
            <div class="col-md-6 mb-3">
                <label class="form-label">Số hàng ghế VIP <span class="text-danger">*</span></label>
                <input type="number" name="num_vip_rows" id="num_vip_rows" class="form-control" min="0" value="<?php echo e($numVipRows); ?>" required>
            </div>
        </div>
        <div class="row">
            <div class="col-md-6 mb-3">
                ...
                <select name="has_couple_row" id="has_couple_row" class="form-select">
                    <option value="1" <?php echo e(!empty($layout['couple_rows']) ? 'selected' : ''); ?>>Có (hàng cuối)</option>
                    <option value="0" <?php echo e(empty($layout['couple_rows']) ? 'selected' : ''); ?>>Không</option>
                </select>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('admin.moderator.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\CineHub_DuAnTotNghiep\resources\views\admin\moderator\screen_edit.blade.php ENDPATH**/ ?>