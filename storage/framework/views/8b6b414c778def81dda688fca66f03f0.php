    ...
    <div class="row">
        ...
        <div class="col-lg-3">
            <div class="profile-luxury-sidebar">
                ...
                <div class="profile-user-info">
                    <h2 class="profile-user-name"><?php echo e($user ? $user->name : 'Người dùng'); ?></h2>
                    <p class="profile-user-email"><?php echo e($user ? $user->email : 'email@example.com'); ?></p>
                </div>
                ...
                <!-- Logout Button -->
                <form method="POST" action="<?php echo e(route('logout')); ?>" style="margin-top: 2rem;">
                    <?php echo csrf_field(); ?>
        ...
        <div class="col-lg-9">
            ...
            <div id="personal-info" class="profile-section active">
                ...
                <form id="personalForm" method="POST" action="<?php echo e(route('profile.update')); ?>" class="profile-form">
                    <?php echo csrf_field(); ?>
                    <?php echo method_field('PUT'); ?>
                    <div class="form-row">
                        <div class="form-group">
                            <label>Họ và tên</label>
                            <input type="text" name="name" value="<?php echo e($user ? $user->name : ''); ?>" placeholder="Nhập họ và tên" class="form-control" disabled>
                        </div>
                        <div class="form-group">
                            <label>Email</label>
                            <input type="email" name="email" value="<?php echo e($user ? $user->email : ''); ?>" placeholder="Nhập email" class="form-control" disabled>
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="tel" name="phone" value="<?php echo e($user ? $user->phone ?? '' : ''); ?>" placeholder="Nhập số điện thoại" class="form-control" disabled>
                        </div>
                        <div class="form-group">
                    ...
                    <div class="form-row">
                        <div class="form-group full-width">
                            <label>Địa chỉ</label>
                            <input type="text" name="address" value="<?php echo e($user ? $user->address ?? '' : ''); ?>" placeholder="Nhập địa chỉ" class="form-control" disabled>
                        </div>
                    </div>
            ...
            <div id="wallet" class="profile-section" style="display: none;">
                ...
                <div class="wallet-balance">
                    <div class="balance-card">
                        ...
                        <div class="balance-info">
                            ...
                            <h3 class="balance-amount"><?php echo e(number_format($user ? $user->points : 0)); ?> điểm</h3>
                        </div>
                    </div>
                </div>
                ...
                <div class="deposit-form">
                    ...
                    <form method="POST" action="<?php echo e(route('profile.depositVnpay')); ?>">
                        <?php echo csrf_field(); ?>
                        <div class="form-group">
            ...
            <div id="security" class="profile-section" style="display: none;">
                ...
                <form method="POST" action="<?php echo e(route('profile.updatePassword')); ?>" class="profile-form">
                    <?php echo csrf_field(); ?>
                    <?php echo method_field('PUT'); ?>
                    <div class="form-group">
...
<script>
    ...
    function uploadAvatar(file) {
        ...
        fetch('<?php echo e(route("profile.uploadAvatar")); ?>', {
            method: 'POST',
            body: formData,
            headers: {
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\CineHub_DuAnTotNghiep\resources\views/profile/index.blade.php ENDPATH**/ ?>