...
<div class="d-flex justify-content-between align-items-center mb-4">
    <h5>Chi tiết ticket #{{ $ticket['id'] }}</h5>
    ...
    <div class="col-md-8">
        <div class="stat-card mb-4">
            ...
            <div class="mb-3">
                ...
                <div class="form-control-plaintext fw-bold">{{ $ticket['subject'] }}</div>
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <div class="form-control-plaintext">
                    ...
                    @endphp
                    <span class="badge bg-info">{{ $issue }}</span>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-4">
        <div class="stat-card mb-4">
            ...
            <div class="mb-3">
                ...
                <div class="form-control-plaintext">{{ $ticket['user_name'] }}</div>
            </div>
            <div class="mb-3">
                <label class="form-label text-muted">Email</label>
                <div class="form-control-plaintext">{{ $ticket['user_email'] }}</div>
            </div>
            <div class="mb-3">
                ...
                <div class="form-control-plaintext">
                    ...
                    @endphp
                    <span class="badge bg-{{ $subscriptionClass }}">{{ $subscriptionName }}</span>
                </div>
            </div>
        </div>
        ...
        <div class="stat-card mb-4">
            ...
            <div class="mb-3">
                ...
                <div class="form-control-plaintext">
                    ...
                    @endphp
                    <span class="badge bg-{{ $statusClass }} status-badge-detail" id="status-badge-detail">{{ $ticket['status'] }}</span>
                </div>
            </div>
            <div class="mb-3">
                <label class="form-label text-muted">Độ ưu tiên</label>
                <div class="form-control-plaintext">
                    <span class="badge bg-{{ match($ticket['priority']) { 'Khẩn cấp'=>'danger','Cao'=>'warning','Trung bình'=>'info', default=>'secondary' } }}">{{ $ticket['priority'] }}</span>
                </div>
            </div>
            <div class="mb-3">
                <label class="form-label text-muted">Phạm vi hỗ trợ</label>
                <div class="form-control-plaintext">
                    <span class="badge bg-{{ match($ticket['category']) { 'Lỗi mua bán vé'=>'danger','Mua bán vé'=>'warning','Lỗi về phim'=>'info','Đăng nhập/Đăng xuất'=>'primary', default=>'secondary' } }}">{{ $ticket['category'] }}</span>
                </div>
            </div>
            <div class="mb-3">
                <label class="form-label text-muted">Người xử lý</label>
                <div class="form-control-plaintext">{{ $ticket['assigned_name'] ?? 'Chưa gán' }}</div>
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <div class="form-control-plaintext"><i class="fas fa-clock me-1"></i>{{ date('d/m/Y H:i:s', strtotime($ticket['updated_at'])) }}</div>
            </div>
        </div>
        ...
        <div class="stat-card">
            ...
            <button type="button" class="btn btn-primary w-100"
                    onclick="openReplyModal({{ $ticket['id'] }}, '{{ addslashes($ticket['user_email']) }}', '{{ addslashes($ticket['subject']) }}')">
