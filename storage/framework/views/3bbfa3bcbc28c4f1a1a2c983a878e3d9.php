...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="<?php echo e(url('?route=admin/foodItemsCreate')); ?>" class="btn btn-primary">
    ...
    <div class="stat-card mb-3">
        <form method="GET" class="row g-2">
            ...
            <div class="col-md-2">
                <a href="<?php echo e(url('?route=admin/foodItems')); ?>" class="btn btn-outline-secondary w-100">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group btn-group-sm">
                                        <a href="<?php echo e(url('?route=admin/foodItemsEdit&id=' . $item['id'])); ?>" class="btn btn-outline-primary" title="Sửa">
                                            <i class="fas fa-edit"></i>
                                        </a>
                                        <button onclick="deleteFoodItem(<?php echo e($item['id']); ?>, '<?php echo e($item['name']); ?>')" class="btn btn-outline-danger" title="Xóa">
...
<script>
    function deleteFoodItem(id, name) {
        if (confirm('Bạn chắc chắn muốn xóa "' + name + '"?')) {
            window.location.href = '<?php echo e(url("?route=admin/foodItemsDelete&id=")); ?>' + id;
        }
    }
</script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('admin.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\CineHub_DuAnTotNghiep\resources\views\admin\food_items.blade.php ENDPATH**/ ?>