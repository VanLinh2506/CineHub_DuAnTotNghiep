...
<head>
    ...
    <title>
        <?php echo e(isset($title) ? $title . ($title != 'CineHub' ? ' - ' : '') : ''); ?>CineHub
    </title>
...
<body>
            ...
            <div class="header-container">
                ...
                <div class="header-left">
                    ...
                    <div class="search-bar">
                        <form method="GET" action="<?php echo e(route('movies.index')); ?>" class="search-form-inline">
                ...
                <nav class="nav-new">
                    ...
                    <div class="nav-dropdown">
                        ...
                        <div class="dropdown-menu">
                            <?php $__currentLoopData = $countries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $country): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <a href="<?php echo e(route('movies.index', ['country' => $country['country']])); ?>"
                                    class="dropdown-item">
                    ...
                    <a href="<?php echo e(route('movies.theater')); ?>" id="booking-link" class="nav-link-new">
                        Vé xem phim
                    </a>
        ...
        <div class="mobile-slide-menu" id="mobileSlideMenu">
            ...
            <div class="mobile-menu-content">
                ...
                <div class="mobile-menu-section">
                    ...
                    <a href="<?php echo e(route('movies.phimle')); ?>" class="mobile-menu-link"
                    ...
                    <a href="<?php echo e(route('movies.phimbo')); ?>" class="mobile-menu-link"
                        onclick="closeMobileMenu()">
                ...
                <div class="mobile-menu-section">
                    ...
                    <div class="mobile-menu-tags">
                        ...
                        <?php $__currentLoopData = array_slice($menuCategories, 0, 8); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

                            <a href="<?php echo e(route('movies.category', $cat['id'])); ?>" class="mobile-menu-tag"
                                onclick="closeMobileMenu()">
                ...
                <?php if(!empty($user)): ?>
                    ...
                    <div class="mobile-menu-section">
                        ...
                        <a href="<?php echo e(route('logout')); ?>" class="mobile-menu-link mobile-menu-logout"
                            onclick="closeMobileMenu()">
        ...
        <div class="notification-wrapper-fixed" id="notificationWrapper">
            ...
            <div class="notification-dropdown" id="notificationDropdown" style="display:none;">
                ...
                <div class="notification-dropdown-header">
                    ...
                    <a href="<?php echo e(isset($isModerator) && $isModerator
    ...
    <script>
        ...
        var isUserLoggedIn = <?php echo json_encode(!empty($user), 15, 512) ?>;
    ...
    </script><?php /**PATH D:\laragon\www\CineHub_DuAnTotNghiep\resources\views\shared\header.blade.php ENDPATH**/ ?>