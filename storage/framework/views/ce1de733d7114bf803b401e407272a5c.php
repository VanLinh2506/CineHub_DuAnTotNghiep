...
<div class="stat-card">
    <form method="POST" action="<?php echo e(route('admin.movies.update', $movie['id'])); ?>" enctype="multipart/form-data">
            ...
            <div class="col-md-6 mb-3">
                ...
                <select class="form-select" id="category_ids" name="category_ids[]" multiple size="4">
                    ...
                    <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($cat['id']); ?>" <?php echo e(in_array($cat['id'], $selectedCategoryIds) ? 'selected' : ''); ?>>
                            <?php echo e($cat['name']); ?>
        ...
        <div class="d-flex justify-content-end gap-2 mt-4">
            <a href="<?php echo e(route('admin.movies.index')); ?>" class="btn btn-secondary">Hủy</a>
    ...
    <script>
        ...
        function deleteEpisode(episodeId) {
            if (
                ...
                form.method = 'POST';
                form.action = "<?php echo e(route('admin.movies.deleteEpisode', ['movieId' => $movie['id'], 'id' => '__ID__'])); ?>".replace('__ID__', episodeId);
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\CineHub_DuAnTotNghiep\resources\views\admin\movies\edit.blade.php ENDPATH**/ ?>