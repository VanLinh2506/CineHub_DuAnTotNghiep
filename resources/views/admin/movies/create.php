...
.section-icon.info { background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); }
.section-icon.media { background: linear-gradient(135deg, #f093fb 0%, #f5576c 100%); }
.section-icon.video { background: linear-gradient(135deg, #4facfe 0%, #00f2fe 100%); }
.section-icon.schedule { background: linear-gradient(135deg, #43e97b 0%, #38f9d7 100%); }
.section-icon.series { background: linear-gradient(135deg, #fa709a 0%, #fee140 100%); }
...
.upload-box.dragover {
    border-color: #667eea;
    background: linear-gradient(145deg, #e8ecff 0%, #dde4ff 100%);
...
<div class="stat-card movie-form-container">
    <form method="POST" action="?route=admin/movies/store" enctype="multipart/form-data">
        <div class="row">
            ...
            <div class="col-md-6 mb-3">
                <label for="thumbnail_file" class="form-label">Poster/Thumbnail <span class="text-danger">*</span></label>
            ...
            <div class="col-md-6 mb-3" id="videoSeriesNotice" style="display: none;">
                ...
                <div class="alert alert-info mb-0" style="min-height: 150px; display: flex; align-items: center;">
                    <div>
                        ...
                        <strong>Phim bộ:</strong> Video được quản lý theo từng tập ở phần "Quản lý tập phim bộ" bên dưới. Bạn có thể thêm video cho từng tập khi tạo tập mới.
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6 mb-3">
                ...
                <input type="url" class="form-control mt-1" id="trailer_url" name="trailer_url" placeholder="https://youtube.com/watch?v=...">
            </div>
        </div>
