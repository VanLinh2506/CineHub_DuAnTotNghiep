        ...
        <div class="row">
            ...
            <div class="col-md-6 mb-3">
                ...
                <div class="upload-box video-upload" id="trailerUploadBox" onclick="document.getElementById('trailer_file').click()">
                    ...
                    <?php if (!empty($movie['trailer_url']) && strpos($movie['trailer_url'], 'http') !== 0): ?>
                        <div id="trailerInfo">
                            <i class="fas fa-check-circle fa-2x text-success mb-2"></i>
...
function addEpisodeInput() {
    ...
    const maxExisting = existingEpisodes.length > 0 ? Math.max(...existingEpisodes) : 0;
    ...
    // Số tập tiếp theo = max(tập hiện có, tập đã thêm) + 1
    const nextEpisode = Math.max(maxExisting, maxAdded) + 1;
